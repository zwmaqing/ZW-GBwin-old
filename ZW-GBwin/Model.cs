...
namespace ZW_GBwin.Model
{
    ...
    public class ZWGB_TerminalDevSet : MQLBase
    {
        ...
        public static readonly FieldBase LoginName = new FieldBase(DbType.Sqlite, "[ZWGB_TerminalDev]", FieldType.Common, "[LoginName]");
        public static readonly FieldBase LoginPass = new FieldBase(DbType.Sqlite, "[ZWGB_TerminalDev]", FieldType.Common, "[LoginPass]");
    }

    [Table("[ZWGB_TaskDeviceSync]", DbType.Sqlite)]
    public class ZWGB_TaskDeviceSyncSet : MQLBase
    {
        public static new MQLBase Select(params FieldBase[] fields)
        {
            return MQLBase.Select(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", fields);
        }
        public static new MQLBase SelectAll()
        {
            return MQLBase.SelectAll(DbType.Sqlite, "[ZWGB_TaskDeviceSync]");
        }
        public static readonly FieldBase RID = new FieldBase(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", FieldType.OnlyPrimaryKey, "[RID]");
        public static readonly FieldBase TaskID = new FieldBase(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", FieldType.Common, "[TaskID]");
        public static readonly FieldBase AreaID = new FieldBase(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", FieldType.Common, "[AreaID]");
        public static readonly FieldBase DeviceID = new FieldBase(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", FieldType.Common, "[DeviceID]");
        public static readonly FieldBase DevSN = new FieldBase(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", FieldType.Common, "[DevSN]");
        public static readonly FieldBase ChannelGroupID = new FieldBase(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", FieldType.Common, "[ChannelGroupID]");
        public static readonly FieldBase DevTaskID = new FieldBase(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", FieldType.Common, "[DevTaskID]");
        public static readonly FieldBase IsSync = new FieldBase(DbType.Sqlite, "[ZWGB_TaskDeviceSync]", FieldType.Common, "[IsSync]");
    }
    ...
    public class ZWGB_PlayTaskSet : MQLBase
    {
        ...
        public static readonly FieldBase TaskID = new FieldBase(DbType.Sqlite, "[ZWGB_PlayTask]", FieldType.Common, "[TaskID]");
        ...
        public static readonly FieldBase WeekStr = new FieldBase(DbType.Sqlite, "[ZWGB_PlayTask]", FieldType.Common, "[WeekStr]");
        ...
        public static readonly FieldBase AreaPath = new FieldBase(DbType.Sqlite, "[ZWGB_PlayTask]", FieldType.Common, "[AreaPath]");
        public static readonly FieldBase IsSystem = new FieldBase(DbType.Sqlite, "[ZWGB_PlayTask]", FieldType.Common, "[IsSystem]");
    ...
    public class ZWGB_TerminalDev : EntityBase
    {
        ...
        {
            get { return GetPropertyValue<String>("LoginPass"); }
            set { SetPropertyValue("LoginPass", value); }
        }
    }

    [Table("[ZWGB_TaskDeviceSync]", DbType.Sqlite)]
    [TablesPrimaryKey(PrimaryKeyType.CustomerGUID, typeof(Int64), "RID")]
    public class ZWGB_TaskDeviceSync : EntityBase
    {
        ...
        {
            get { return GetPropertyValue<Int64>("DeviceID"); }
        ...
        public String DevSN
        {
            get { return GetPropertyValue<String>("DevSN"); }
            set { SetPropertyValue("DevSN", value); }
        }
        ...
        {
            get { return GetPropertyValue<Int32>("ChannelGroupID"); }
            set { SetPropertyValue("ChannelGroupID", value); }
        }

        /// <summary>
        /// 
        /// </summary>
        public Int32 DevTaskID
        {
            get { return GetPropertyValue<Int32>("DevTaskID"); }
            set { SetPropertyValue("DevTaskID", value); }
        }
    ...
    public class ZWGB_PlayTask : EntityBase
    {
        ...
        {
            get { return GetPropertyValue<String>("WeekStr"); }
            set { SetPropertyValue("WeekStr", value); }
        }
        ...
        {
            get { return GetPropertyValue<String>("AreaPath"); }
            set { SetPropertyValue("AreaPath", value); }
        }
        ...
        {
            get { return GetPropertyValue<Boolean>("IsSystem"); }
            set { SetPropertyValue("IsSystem", value); }
        }
