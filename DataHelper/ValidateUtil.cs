...
namespace DataHelper
{
    ...
    public class ValidateUtil
    {
        ...
        public static bool IsValidUserName(string userName)
        {
            ...
            if (userNameLength >= 4 && userNameLength <= 20 && Regex.IsMatch(userName, @"^([\u4e00-\u9fa5A-Za-z_0-9]{
0,
})$"))
            {
        ...
        public static bool IsValidPassword(string password)
        {
            ...
            return Regex.IsMatch(password, @"^[A-Za-z_0-9]{
6,16
}$");
        ...
        public static bool IsIdCard(string idCard)
        {
            ...
            if (idCard.Length == 15)
            {
                ...
                return Regex.IsMatch(idCard, @"^[1-9]\d{
7
...
9
        ...
        static public bool IsValidURL(string url)
        {
            ...
            return Regex.IsMatch(url, @"^(http|https|ftp)\://[a-zA-Z0-9\-\.]+\.[a-zA-Z]{
2,3
        ...
        public static bool IsValidIP(string ip)
        {
            ...
            return Regex.IsMatch(ip, @"^((2[0-4]\d|25[0-5]|[01]?\d\d?)\.){
3
