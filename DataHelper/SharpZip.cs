//C#利用SharpZipLib进行文件压缩与解压的帮助类

//SharpZipLib是一个开源的C#zip文件解压压缩类，使用它首先需要下载ICSharpCode.SharpZipLib.dll（自己百度）。然后使用下面的类就可以进行文件以及目录的压缩和解压了：
...
namespace ZhiWeiTech.DataHelper
{
