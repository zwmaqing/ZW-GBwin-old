...
namespace DataHelper.Files
{
    ...
    public class CSVHelper
    {
        ...
        public static DataTable CSVToDataTableByOledb(string csvPath)
        {
            ...
            if (!DataHelper.DiskDirFileIo.IsExistFile(csvPath))
            {
        ...
        public static DataTable CSVToDataTableByStreamReader(string csvPath)
        {
            ...
            using (StreamReader reader = new StreamReader(csvPath, Encoding.Default))//FileUtil.GetEncoding(csvPath)))
            {
        ...
        public static void DataTableToCSV(DataTable dt, string csvPath)
        {
           ...
           DataHelper.DiskDirFileIo.WriteText(csvPath, csvText.ToString(), Encoding.Default);
        }
    }
}